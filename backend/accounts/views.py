...
from django.contrib.auth import views as dj_auth_view
...
class LoginView(RedirectAuthenticatedUserMixin, dj_auth_view.LoginView):
    template_name = 'login.html'
    success_url = reverse_lazy('tantorial:index')


class PasswordChangeView(dj_auth_view.PasswordChangeView):
    success_url = reverse_lazy("ecommerceapp:customerprofile")
    template_name = "forgotpassword/password_change.html"
        ...
        if password_reset_form.is_valid():
            ...
            if associated_users.exists():
                for user in associated_users:
                    ...
                    messages.success(
                        request, 'A message has been sent to your email')
                    return redirect("/")
